...
import type { IOVMStateCommitmentChain } from "../IOVMStateCommitmentChain";

export class IOVMStateCommitmentChain__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOVMStateCommitmentChain {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as IOVMStateCommitmentChain;
  }
}
