...
import type { IOVMCanonicalTransactionChain } from "../IOVMCanonicalTransactionChain";

export class IOVMCanonicalTransactionChain__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOVMCanonicalTransactionChain {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as IOVMCanonicalTransactionChain;
  }
}
