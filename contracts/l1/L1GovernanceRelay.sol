...
contract L1GovernanceRelay is OVM_CrossDomainEnabled {
  ...
  constructor(address _l2GovernanceRelay, address _l1messenger) OVM_CrossDomainEnabled(_l1messenger) {
    wards[msg.sender] = 1;
  ...
  function relay(
    ...
    bytes memory data = abi.encodeWithSelector(L2GovernanceRelay.relay.selector, target, targetData);

    // Send calldata into L2
    sendCrossDomainMessage(l2GovernanceRelay, data, l2gas);
  }
}
