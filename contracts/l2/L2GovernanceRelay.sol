...
contract L2GovernanceRelay is OVM_CrossDomainEnabled {
  ...
  constructor(address _l2CrossDomainMessenger) OVM_CrossDomainEnabled(_l2CrossDomainMessenger) {}

  function init(address _l1GovernanceRelay) public {
    ...
    onlyFromCrossDomainAccount(address(l1GovernanceRelay))
  {
    ...
    require(
      _l1GovernanceRelay == l1GovernanceRelay && _messenger == messenger,
      'L2GovernanceRelay/illegal-storage-change'
    );
  }
}
